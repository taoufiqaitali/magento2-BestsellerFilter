<?php
namespace Taoufiqaitali\BestsellerFilter\Block\Product\ProductList;
...
class Toolbar extends \Magento\Catalog\Block\Product\ProductList\Toolbar
{
    public function setCollection($collection)
    {
        ...
        if ($this->getCurrentOrder() && $this->getCurrentOrder()!="featured" && $this->getCurrentOrder()!="bestseller") {
